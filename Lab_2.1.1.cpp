...
class Equation {
public:
	virtual Equation* derivative(std::string var) const = 0;
	virtual int eval(std::string term) = 0;
	virtual std::string eq_to_str() const = 0;
...
public:
	...
	Equation* derivative(std::string var) const
	{
		return new Number(0);
	}
